...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased bg-neutral">
        <div class="min-h-screen ">
            ...
            <div class="relative mx-auto px-4 sm:px-6 lg:px-14 mt-8 lg:mt-16 h-[calc(100vh-11rem)] overflow-hidden">
                <!-- Mockup -->
                <div class="absolute bottom-0 right-0 pointer-events-none">
                  <img
                    src="{{ Vite::asset('resources/images/device-mockup.png') }}"
                    alt="latr app mockup"
                    class="w-[75vw] lg:w-auto max-w-full"
                    onerror="this.src='https://placehold.co/600x400?text=latr+App+Mockup'"
                  />
                </div>

                <!-- Content -->
                <div class="lg:-mt-10 flex flex-col lg:flex-row items-center justify-between h-full relative z-10">
                  <div class="lg:w-1/2 ">
